...
<head>
    ...
    <!-- Bootstrap core CSS-->
    <link href="<?= base_url()?>ext/back/assets/css/bootstrap.min.css" rel="stylesheet"/>
    <!-- animate CSS-->
    <link href="<?= base_url()?>ext/back/assets/css/animate.css" rel="stylesheet" type="text/css"/>
    <!-- Icons CSS-->
    <link href="<?= base_url()?>ext/back/assets/css/icons.css" rel="stylesheet" type="text/css"/>
    <!-- Custom Style-->
    <link href="<?= base_url()?>ext/back/assets/css/app-style.css" rel="stylesheet"/>
...
<script src="<?= base_url()?>ext/back/assets/js/jquery.min.js"></script>
<script src="<?= base_url()?>ext/back/assets/js/popper.min.js"></script>
<script src="<?= base_url()?>ext/back/assets/js/bootstrap.min.js"></script>
